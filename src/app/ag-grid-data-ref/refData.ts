export default class RefData {
  ...
  static lastNames = ['Beckham', 'Black', 'Braxton', 'Brennan', 'Brock', 'Bryson', 'Cadwell',
    ...
    'DoFeban', 'Easton', 'Fisher', 'Fletcher', 'Grady', 'Greyson', 'Griffin', 'Gunner',
  ...
  static note = [
    'Fusce vel elementum arcu. Sed lorem velit, vestibulum id convallis dictum, ultricies in nulla. Aenean mattis, velit vel tempor hendrerit.',
    'Integer luctus vel risus sit amet vulputate. Suspendisse laoreet purus quis purus elementum, vel pulvinar erat viverra. Vivamus at nulla lacinia.',
    'tristique mauris eget, interdum turpis. Nunc viverra malesuada libero eget ornare. Etiam eleifend dolor ligula.',
    'vitae vehicula ipsum fringilla in. Etiam nec magna lacus. Nulla magna elit, posuere ac rutrum eu, aliquet ac nisi.',
    'Maecenas lobortis non nibh vitae posuere. Fusce rutrum vel turpis sed malesuada.',
    'Proin dapibus in est nec blandit. Maecenas volutpat mollis risus at auctor. Praesent porttitor, mauris at tincidunt dictum, ex turpis sagittis eros.',
    'quis aliquet lorem diam ac lectus. Nunc sit amet magna quam. Nam sit amet dictum nisi. Pellentesque sed euismod odio. Vivamus gravida erat nisl, sed porttitor odio consequat ut.',
    'Sed porttitor, orci nec scelerisque blandit, nisl augue posuere dolor, sit amet congue justo tortor eu ante. Maecenas non faucibus tellus.',
    'Curabitur feugiat eros at dictum volutpat. Sed congue, lorem at ultricies scelerisque, leo eros pharetra nisi, a dapibus sem nulla nec felis.'
  ];
}
