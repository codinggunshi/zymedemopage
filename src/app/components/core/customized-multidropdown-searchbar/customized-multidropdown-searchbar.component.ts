...
import { ListItem, IDropdownSettings } from './customized-multidropdown-searchbar.model';

export const DROPDOWN_CONTROL_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => CustomizedMultidropdownSearchbarComponent),
  multi: true
};
const noop = () => { };

@Component({
  selector: 'app-customized-multidropdown-searchbar',
  templateUrl: './customized-multidropdown-searchbar.component.html',
  styleUrls: ['./customized-multidropdown-searchbar.component.scss'],
  providers: [DROPDOWN_CONTROL_VALUE_ACCESSOR],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class CustomizedMultidropdownSearchbarComponent implements ControlValueAccessor {
  ...
  @Input() defaultSettings: IDropdownSettings = {
