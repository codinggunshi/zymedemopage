...
export const CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => InputBoxWithbtnComponent),
  multi: true
};
...
@Component({
  selector: 'app-input-box-withbtn',
  templateUrl: './input-box-withbtn.component.html',
  styleUrls: ['./input-box-withbtn.component.scss'],
  providers: [CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR]
})
export class InputBoxWithbtnComponent implements OnInit, AfterViewInit, ControlValueAccessor {
